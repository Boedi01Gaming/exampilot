						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								...
								<div class="info-bx text-center">
									...
									<h4><a href="#">Empower Your Learning</a></h4>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								...
								<div class="info-bx text-center">
									...
									<h4><a href="#">Learn Anytime, Anywhere</a></h4>
									<a href="#" class="btn radius-xl">View More</a>
								</div>
							</div>
						</div>
                ...
                <div class="container">
					<div class="row">
						<div class="col-md-12 heading-bx left">
							...
							<p>Join thousands of students advancing their careers online. Flexible schedules with world-class instructors.</p>
						</div>
					</div>
					<div class="row">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center text-white">
							<h2>CBT & Online Learning App</h2>
							<h5>Achieve Your Goals, Learn Anytime, Anywhere. Join thousands of students advancing their careers online.</h5>
							<form class="cours-search" method="post" action="search-today">
						...
						<div class="row">
							<div class="col-md-4 col-sm-6">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
										<h3><i class="ti-user"></i><span class="counter">1.2</span>K</h3>
									</div>
									<span class="cours-search-text">Over 1,204 students</span>
								</div>
							</div>
							<div class="col-md-4 col-sm-6">
								<div class="cours-search-bx m-b30">
									...
									<span class="cours-search-text">3,000 Courses.</span>
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="cours-search-bx m-b30">
									...
									<span class="cours-search-text">200 instructors.</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center heading-bx">
							...
							<p class="m-b0">Upcoming Education Event.</p>
						</div>
					</div>
					<div class="row">
                ...
                <div class="container">
					<div class="row">
						<div class="col-md-12 text-white heading-bx left">
							...
							<p>Listen to what people say about us, from the unset of our establishments we meant imparting knowledge & reducing distraction by setting up an all in one CBT socialmedia app</p>
						</div>
					</div>
                ...
                <div class="container">
					<div class="row">
						<div class="col-md-12 heading-bx left">
							...
							<p>Recent Blog News From School Updates, and Other Important Posts.</p>
						</div>
					</div>
